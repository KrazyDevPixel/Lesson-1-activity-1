...
window=Tk()
window.title("Afterschool routine")
window.geometry("400x320")
heading=Label(
    window,
    text="My afterschool routine",
    font=("Arial",16,"bold")
)
heading.pack(pady=10)
instruction=Label(window,text="Enter your next after-school task")
instruction.pack()
...
routine_message=Label(window,text="Click here to check your routine", bg="#doefff",width=32,height=3)
